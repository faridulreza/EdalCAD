...
const char sBanner[] ="\xc2\xa9 EdalCAD\n"\
"EdalCAD is free and open-source software licensed under the terms of LGPL2+ license.\n"\
"EdalCAD wouldn't be possible without FreeCAD community.\n"\
"  #####     #        #   ####   ###   ####  \n" \
"  #         #        #  #       # #   #   # \n" \
"  #         #        #  #      #   #  #   # \n" \
"  ####  #####  ###   #  #      #####  #   # \n" \
