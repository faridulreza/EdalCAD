...
Configuration and variables of EdalCAD installer
*/
...
!define APP_NAME "EdalCAD"
!define APP_VERSION_NUMBER "${APP_VERSION_MAJOR}.${APP_VERSION_MINOR}.${APP_VERSION_REVISION}.${APP_VERSION_BUILD}"
# For the proposed install folder we use the scheme "EdalCAD 0.18" 
# however for the Registry, we need the scheme "EdalCAD 0.18.x" in order
...
!define APP_WEBPAGE "https://www.edalcad.org/"
!define APP_WEBPAGE_INFO "${APP_NAME} Website"
!define APP_WIKI "https://wiki.edalcad.org/Main_Page"
...
!define APP_REGKEY "SOFTWARE\${APP_NAME}${APP_SERIES_KEY}" # like "EdalCAD0180"
